...
> 사용 모델: gemini-2.5-flash-lite (분석) / gemini-2.5-flash-image (이미지생성, 나노바나나)
> 503/429 에러 시 자동 재시도 최대 3회 (exponential backoff) + 폴백 모델 전환
